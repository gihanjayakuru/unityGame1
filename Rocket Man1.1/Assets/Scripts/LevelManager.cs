...
public class LevelManager : MonoBehaviour
{
   ...
   // private int currentLevel; bbbbbbbbbbbbbbbbbbbbb########
    ...
    //gameplay
   //private bool isMoving = false;  bbbbbbbbbbbbbbb######
    ...
    private void Awake()
    {
        ...
        currentSpawnZ = 0;
        //currentLevel = 0; bbbbbbbbbbbbbbbb########
    ...
    private void Update()
    {
        if(currentSpawnZ - cameraContainer.transform.position.z < DISTANCE_BEFORE_SPAWN)
            GenerateSegment();
